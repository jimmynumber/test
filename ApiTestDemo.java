...
$ git remote add origin https://github.com/jimmynumber/test.git
...
public class ApiTestDemo
{
	...
	private static final Log logger = LogFactory.getLog(ApiTestDemo.class);
	
	private String cmd = "11";
	private String mobileStr = "15502120426";
	private String content = "短信发送测试内容 via  IM JAVA API ";
	private long smId = 10;
	private int smType = 0;
	private String url = "wap.sohu.com";
	private String host = "10.0.1.70";
	private String dbName = "mas";
	private String apiId = "ecad";
	private String name = "ecad";
	private String pwd = "ecad";
